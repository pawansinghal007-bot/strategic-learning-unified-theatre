    ...
    <div>
      ...
      <div className="space-y-4">
        <div className="bg-white dark:bg-gray-800 p-4 rounded shadow">
          <label htmlFor="poll-interval" className="block text-sm">Poll interval (ms)</label>
          <input id="poll-interval" type="number" value={cfg.pollIntervalMs || 30000} onChange={(e) => update({ pollIntervalMs: Number(e.target.value) })} className="mt-1 p-2 border rounded w-48" />
        </div>
