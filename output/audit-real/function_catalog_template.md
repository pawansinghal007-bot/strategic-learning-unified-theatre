...
| init_collection | `index_repo.py` | 102 | internal | Direct | low |  |  |
| is_text_file | `index_repo.py` | 116 | internal | Direct | low |  |  |
| chunk_text | `index_repo.py` | 135 | internal | Direct | low |  |  |
| embed | `index_repo.py` | 145 | internal | Direct | medium |  |  |
| chunk_id | `index_repo.py` | 157 | internal | Direct | low |  |  |
| remove_existing_file | `index_repo.py` | 166 | internal | Direct | low |  |  |
| index_file | `index_repo.py` | 183 | internal | Direct | low |  |  |
| scan_repo | `index_repo.py` | 229 | internal | Direct | low |  |  |
...
| confidence | `output/repo_function_audit.py` | 142 | internal | CLI, Handler, Scheduler, Test | high |  |  |
| repo_name | `output/repo_function_audit.py` | 153 | internal | CLI, Handler, Scheduler, Test | high |  |  |
| main | `output/repo_function_audit.py` | 156 | internal | CLI, Handler, Scheduler, Test | high |  |  |
