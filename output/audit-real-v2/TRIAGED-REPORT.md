...
> **Note:** 7 additional JSX components resolved in v2 (see 33 above). These 5 remained zero because their JSX usage is in a *different file* (App.jsx routes them), and the same-file regex only catches same-file composition.
