...
| confidence | `output/repo_function_audit.py` | 165 | internal | CLI, Handler, Scheduler, Test | high |  |  |
| detect_path_invoked | `output/repo_function_audit.py` | 177 | internal | CLI, Handler, Scheduler, Test | high |  |  |
| repo_name | `output/repo_function_audit.py` | 191 | internal | CLI, Handler, Scheduler, Test | high |  |  |
| main | `output/repo_function_audit.py` | 194 | internal | CLI, Handler, Scheduler, Test | high |  |  |
...
| StatusBar | `renderer/components/StatusBar.jsx` | 35 | public | Direct | low |  |  |
...
| LiveFeed | `renderer/screens/LiveFeed.jsx` | 3 | public | Direct | low |  |  |
| onEvent | `renderer/screens/LiveFeed.jsx` | 10 | internal | Direct | medium |  |  |
| LocalLLM | `renderer/screens/LocalLLM.jsx` | 8 | public | Direct | low |  |  |
...
| ProgressLog | `renderer/screens/ProgressLog.jsx` | 4 | public | Direct | low |  |  |
...
| getBinding | `src/accounts/workspace.js` | 39 | public | Direct | high |  |  |
