...
- [x] src/llm/providers/local.ts updated
- [x] src/llm/providers/openai.ts committed
- [x] src/llm/providers/gemini.ts committed
- [x] src/llm/providers/groq.ts committed
- [x] src/llm/providers/perplexity.ts committed
- [x] src/llm/providers/index.ts committed
- [x] src/llm/gateway.ts replaced
- [x] src/llm/index.ts updated
...
- [x] Error normalization committed
