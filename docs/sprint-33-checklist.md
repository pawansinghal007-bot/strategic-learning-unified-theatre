...
- [x] src/ui/provider-dashboard.html updated with Sprint 33 panels
- [x] docs/sprint-33-scope.md committed
- [x] docs/sprint-33-checklist.md committed
...
- [x] All four operations reachable from renderer
