...
- [x] electron-ui/preload.cjs workspaceQuota block extended
- [x] src/ui/types.d.ts updated
- [x] src/ui/provider-dashboard.html updated
- [x] docs/sprint-41-scope.md committed
- [x] docs/sprint-41-checklist.md committed
...
- External notification webhook hooks
