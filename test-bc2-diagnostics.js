...
const SCHEMA_PATH =
  "c:\\SW Development\\VS Code Agent\\files\\bc2-native-host\\native-host\\schema.sql";
...
if (!existsSync(DB_PATH)) {
  ...
  console.log(
    "   Ensure native host has been run at least once to initialize it.\n",
  );
}
...
console.log(
  "To see Flask error logs, check the terminal where api.py was started.",
);
...
console.log(
  '   - The terminal where "python api.py" was started should show errors',
);
...
console.log(
  "   - Run the browser extension again (will recreate and initialize schema)\n",
);
