...
| 72     | TBD — evaluate whether any source files modified in Sprint 60-71 are undergoing test coverage growth; if yes, add targeted tests for those files to move new_coverage; if no eligible files exist, escalate to human admin decision about new-code-period reset.                                                                                                                                                                                                                             | Next     |
