...
| 72     | Evaluate whether any source files actually modified in Sprints 60-71 fall inside Sonar's new-code period with uncovered branches. If yes, add targeted tests for those specific files only. If no qualifying files exist, document the hard automation boundary and treat new-code-period reset as a human Sonar admin decision.                                                                                                                                                                                                                             | Next     |
...
Sprint 72 (modified-newcode boundary evaluation) is the current sprint.
